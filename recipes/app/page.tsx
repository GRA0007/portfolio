...
const Home = async () => {
  ...
  return (
    <div className="mx-auto mb-16 w-full max-w-7xl grid-cols-[1fr_auto] grid-rows-[auto_1fr] gap-x-10 px-6 [grid-template-areas:'nav_search'_'results_search'] md:grid md:px-16">
